...
- Capstone project(졸업 프로젝트) in Division of Mechanical & Biomedical Engineering
...
### 실행 방법
1️⃣ 아두이노 Parkinson.ino 코드 실행

2️⃣ EnjoyRhythm 게임 실행

3️⃣ 명령 프롬프트에서 keymatching.py 파이썬 코드 실행
  - 예시) python "python 파일 경로"
